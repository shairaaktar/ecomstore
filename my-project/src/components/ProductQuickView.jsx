  ...
  />
      ...
      >
        ...
        className="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                <button 
                onClick={onClose}
               className="absolute right-1   text-gray-400 hover:text-gray-500 sm:right-6 sm:top-8 md:right-6 md:top-6 lg:right-8 lg:top-8"
              // className="absolute top-2 right-2 sm:top-4 sm:right-4 text-gray-400 hover:text-gray-500 focus:outline-none z-50"
              >
